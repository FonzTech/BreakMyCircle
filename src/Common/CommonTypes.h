...
#define RESOURCE_TEXTURE_GUI_BGMUSIC_ON "tex_gui_bgmusic_on"
#define RESOURCE_TEXTURE_GUI_BGMUSIC_OFF "tex_gui_bgmusic_off"
...
#define RESOURCE_TEXTURE_GUI_BUTTON_4X1 "tex_gui_button_4x1"
